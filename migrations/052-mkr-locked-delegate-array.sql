DROP FUNCTION IF EXISTS api.mkr_locked_delegate_array(CHAR,INTEGER,INTEGER);

CREATE OR REPLACE FUNCTION api.mkr_locked_delegate_array(arg_address CHAR[], unixtime_start INTEGER, unixtime_end INTEGER)
RETURNS TABLE (
