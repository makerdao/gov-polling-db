-- Dropping function as the amount of parameters changed.
drop function if exists api.delegates;

-- Same function, but adding support to passing an array of addresses to sort the table by those addresses first.
